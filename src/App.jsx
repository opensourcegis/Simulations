...
const simulators = [
  ...
  { title: 'Boresight & Lever-Arm', category: 'LiDAR', level: 'Advanced', description: 'Visualize direct-georeferencing sensor integration in 3D: the lever-arm offsets from the IMU to the GPS antenna and laser scanner, plus the boresight rotational misalignment — and see how an uncalibrated boresight becomes a ground error.', tags: ['Direct georeferencing', 'Lever arm', 'Boresight', 'IMU / GNSS', 'Sensor fusion'], path: '?simulation=boresight', kind: 'boresight', status: 'Native React' },
