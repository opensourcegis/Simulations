...
const simulators = [
  { title: 'LiDAR Ranging', category: 'LiDAR', level: 'Beginner', description: 'Fire a laser pulse, time its round trip, and see how a rangefinder turns time of flight into distance with R = c·t / 2.', tags: ['Time of flight', 'Speed of light', 'Range resolution'], path: '?simulation=lidar-ranging', kind: 'ranging', status: 'Native React' },
